...
public class InfoScreen extends BaseScreen {
    ...
    public InfoScreen(BlockPos pos){
        super(new TextComponentTranslation("gui.tesseract.info.title"));
        this.pos = pos;
    }
...
//        matrixStack.pop();
    ...
    private void drawPageFrame(){
        ScreenUtils.fillRect(5,5, this.sizeX() - 11, 1, 85 / 255f, 85 / 255f, 58 / 255f, 1);
        ScreenUtils.fillRect(5,5, 1, page.getTopHeight() + 1, 198 / 255f, 198 / 255f, 198 / 255f, 1);
        ScreenUtils.fillRect(5,6 + page.getTopHeight(), 1, 1, 168 / 255f, 168 / 255f, 168 / 255f, 1);
        ScreenUtils.fillRect(this.sizeX() - 6,5, 1, 1, 168 / 255f, 168 / 255f, 168 / 255f, 1);
        ScreenUtils.fillRect(6,6 + page.getTopHeight(), this.sizeX() - 11, 1, 255 / 255f, 255 / 255f, 255 / 255f, 1);
        ScreenUtils.fillRect(this.sizeX() - 6,6, 1, page.getTopHeight() + 1, 255 / 255f, 255 / 255f, 255 / 255f, 1);
        ScreenUtils.fillRect(6,6, this.sizeX() - 12, page.getTopHeight(), 122 / 255f, 122 / 255f, 122 / 255f, 1);
    }
}
